...
<head>
    ...
    <!-- DataTables.js and DataTables.css -->
        ...
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
                ...
                <x-admin-nav-link :href="route('admin.resersvation.index')"
                    ...
                    <div class="flex items-center "> 
                        <svg class="h-4 w-4 text-black-500 mr-2"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" />  <line x1="3" y1="6" x2="21" y2="6" />  <path d="M16 10a4 4 0 0 1-8 0" /></svg>  
                    {{ __('Resersvation') }}
                    </div>
                </x-admin-nav-link>
            ...
            :active="request()->routeIs('admin.customer.index')">
            <div class="flex items-center "> 
                <svg class="h-4 w-4 text-black-500 mr-2"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="9" cy="7" r="4" />  <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" />  <path d="M16 11h6m-3 -3v6" /></svg>
            {{ __('Customer') }}
            </div>
            </x-admin-nav-link>
