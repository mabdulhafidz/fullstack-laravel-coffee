                ...
                <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900" id="new-products-count">{{ $menuCount }}</span>
                                <h3 class="text-base font-normal text-gray-500">Jumlah Menu</h3>
                            </div>
                            <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold" id="new-products-percentage">
                                @if ($percentageChange > 0)
                                    <span class="text-green-500">&#9650; {{ $percentageChange }}%</span>
                                @elseif ($percentageChange < 0)
                                    <span class="text-red-500">&#9660; {{ abs($percentageChange) }}%</span>
                                @else
                                    <span>0%</span>
                                @endif
                        </div>
                    ...
                    <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900" id="new-products-count">{{ $customerCount }}</span>
                                <h3 class="text-base font-normal text-gray-500">Jumlah Customer</h3>
                            </div>
                            <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold" id="new-products-percentage">
                                {{-- @if ($percentageChangeCustomer > 0)
                                    <span class="text-green-500">&#9650; {{ $percentageChangeCustomer }}%</span>
                                @elseif ($percentageChangeCustomer < 0)
                                    <span class="text-red-500">&#9660; {{ abs($percentageChangeCustomer) }}%</span>
                                @else
                                    <span>0%</span>
                                @endif --}}
                            </div>
