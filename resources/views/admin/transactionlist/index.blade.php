        ...
        <div class="mr-3">
            ...
            <div class="mt-1">
                <div class="flex space-x-4 m-2 p-2" id="searchResults">
                    ...
                    <form id="export-form" action="{{ route('admin.transactionlist.export') }}" method="POST"
                        style="display: none;">
                        @csrf
                    </form>
                    ...
                    <form action="{{ route('admin.transactionlist.index') }}" method="GET">
                        <div class="flex items-center">
                            ...
                            <button type="submit"
                                class="bg-gray-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Search</button>
                            @if (request()->has('transaction_date'))
                                <a href="{{ route('admin.transactionlist.index') }}" class="text-sm ml-2">Clear
                                    Search</a>
                            @endif
                        </div>
                    </form>
